...
export const getAppointments = async (req, res) =>{
    ...
    const query = "SELECT  a.appointment_id, a.customer_id, a.employee_id, a.start_time, a.end_time, a.date, a.service_status, u.name, u.contact FROM employees e JOIN appointments a ON a.employee_id = e.employee_id JOIN customers c ON c.customer_id = a.customer_id JOIN users u ON u.user_id = c.user_id WHERE e.employee_id = ?";
