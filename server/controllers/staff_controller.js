...
export const getAppointments = async (req, res) =>{
    ...
    const query = "SELECT  a.appointment_id, a.customer_id, a.start_time, a.end_time, a.date, a.app_status, u.name, u.contact FROM employees e JOIN client_service cs ON cs.employee_id = e.employee_id JOIN customers c ON c.customer_id = a.customer_id JOIN users u ON u.user_id = c.user_id WHERE e.employee_id = ?";
